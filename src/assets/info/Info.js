...
export const info = {
    ...
    bio: `Programador há mais de 6 anos, nesse período fui aprendendo muito com dezenas de cursos profissionalizantes na área, e também com várias oportunidades de colocar tudo em prática. Nas diversas oportunidades que tive, trabalhei em muitos projetos, dos quais alguns estava sozinho e outros em equipe, todos eles me forneceram conhecimento e prática para estar trabalhando com versionamento de código com confiança, domínio em regras de negócios mais complexas, modelagem de dados, banco de dados, Scrum..
    `,
    skills: {
